...
export const Footer: React.FC = () => {
  ...
  const footerLinks = {
    navegacion: [
      ...
      { name: 'Esencia', href: '#style' },
      { name: 'Contacto', href: '#contact' }
    ],
    servicios: [
      { name: 'Marca Personal y Portafolio', href: '/services/personal-brand' },
      { name: 'Diseño de Marca Web', href: '/services/web-brand' },
      { name: 'Landing Page', href: '/services/landing' },
      { name: 'Invitaciones para bodas', href: '#services' },
      { name: 'Restaurantes y cafeterías', href: '/services/restaurants' },
      { name: 'Tienda Online', href: '/services/stores' },
      { name: 'Clínicas estéticas y odontológicas', href: '/services/medical' }
    ]
  };
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="">
            <h4 className="text-lg font-semibold mb-6">Contactame</h4>
            ...
            <a href='mailto:dg.alvarezr@gmail.com' className="text-gray-400 hover:text-white transition-colors duration-200">
              dg.alvarezr@gmail.com
            </a>
            <a href="tel:+573182010789" className="">
              <p className="text-gray-400 hover:text-white transition-colors duration-200 mt-2">
                +57 318 201 0789
              </p>
            </a>
          </div>
